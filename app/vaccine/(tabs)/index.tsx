...
export default function VaccineHistoryScreen() {
  ...
  const loadVaccineRecords = async () => {
    try {
      ...
      // Load notifications after records are loaded
      await checkSecondDoseNotifications()
    } catch (error) {
      console.error("Error loading vaccine records:", error)
      // Set empty arrays on error to prevent infinite loops
      setVaccineRecords([])
      setSecondDoseNotifications([])
    }
  }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.subtitle}>Track your immunization records</Text>
        </View>
        
        <TouchableOpacity
          style={[styles.notificationIcon, notificationCount > 0 && styles.hasNotifications]}
        ...
        >
          <Ionicons
            ...
            size={24}
            color={notificationCount > 0 ? "#fff" : "#2196F3"}
          />
          {notificationCount > 0 && (
