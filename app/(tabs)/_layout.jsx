...
const VaccineIcon = ({ color }) => (
    <Svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={color} width={28} height={28}>
        <Path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.169.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c.332.332.332.87 0 1.202l-4.344 4.344a.75.75 0 01-1.061 0L9.477 16.5a.75.75 0 01-.22-.53v-1.47M5 14.5L3.598 15.902c-.332.332-.332.87 0 1.202l4.344 4.344a.75.75 0 001.061 0L14.523 16.5a.75.75 0 00.22-.53v-1.47" />
    </Svg>
);
  ...
  return (
    <Tabs
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Vaccines',
          tabBarIcon: ({ color }) => <VaccineIcon color={color} />,
          header: () => <AppHeader title="Vaccine Tracker" />,
        }}
      />
    </Tabs>
  );
